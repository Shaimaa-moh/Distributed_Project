...
class ServerSelect(ViewController):
    ...
    def __init__(self):
        ...
        self.IPLabel = Label("IP: 192.168.1.15", self.font)
        ...
        self.submitButton = Button(
            submitPanel, submitLabel, self.palette["tur"], self.palette["dark"])
    ...
    def shouldAdvance(self, controller):
        ...
        if self.ready:
            ...
            controller.socket.connect(("192.168.1.15", portNumber))
            return True
        return False
    ...
    def drawScreen(self, controller):
        ...
        self.portField.draw(
            self.screen, self.palette["tur"], self.palette["dark"])
...
class ChatRoom(ViewController):
    ...
    def __init__(self):
        ...
        self.screen = pg.display.set_mode((750, 600))
...
class Client:
    ...
    def run(self):
        # portNumber = int(self.portField.text.text.split(": ")[1])
        self.socket.connect(("192.168.1.15", 3000))
        running = True
        while running:
